...
namespace Template.Configurator
{
    public partial class FrmConfigurador : Form
    {
        ...
        {
            textoDireccionEmisor.Text = "b2becheverriaizquierdo@iconstruye.com";
            textoNombreEmisor.Text = "B2B Echeverría Izquierdo";
            textoDireccionReceptor.Text = "gerardogaldames@gmail.com";
